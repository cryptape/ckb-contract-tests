...
use ckb_rust_std::io;
use ckb_rust_std::io::{
    BorrowedBuf, BufRead, BufReader, BufWriter, Error, ErrorKind, LineWriter, Read, Seek, SeekFrom,
    Write,
};
...
fn test_buffered_reader_read_buf() {
    debug!("test buffered_reader_read_buf");
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
    let mut reader = BufReader::with_capacity(2, inner);
...
fn test_buffered_reader_seek() {
    debug!("test buffered_reader_seek");
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
...
fn test_buffered_reader_seek_relative() {
    debug!("test buffered_reader_seek_relative");
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
    let mut reader = BufReader::with_capacity(2, io::Cursor::new(inner));
...
fn test_buffered_reader_stream_position() {
    debug!("test buffered_reader_stream_position");
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
    let mut reader = BufReader::with_capacity(2, io::Cursor::new(inner));
...
fn test_buffered_reader_invalidated_after_read() {
    debug!("test buffered_reader_invalidated_after_read");
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
...
fn test_buffered_reader_invalidated_after_seek() {
    debug!("test buffered_reader_invalidated_after_seek");
    let inner: &[u8] = &[5, 6, 7, 0, 1, 2, 3, 4];
    let mut reader = BufReader::with_capacity(3, io::Cursor::new(inner));
...
fn test_buffered_reader_seek_underflow() {
    debug!("test buffered_reader_seek_underflow");
...
fn test_buffered_reader_seek_underflow_discard_buffer_between_seeks() {
    debug!("test buffered_reader_seek_underflow_discard_buffer_between_seeks");
...
fn test_buffered_reader_read_to_end_consumes_buffer() {
    debug!("test buffered_reader_read_to_end_consumes_buffer");
...
fn test_buffered_reader_read_to_string_consumes_buffer() {
    debug!("test buffered_reader_read_to_string_consumes_buffer");
...
fn test_buffered_writer_inner_flushes() {
    debug!("test buffered_writer_inner_flushes");
...
fn test_buffered_writer_seek() {
    debug!("test buffered_writer_seek");
...
fn partial_write_buffers_line() {
    debug!("test partial_write_buffers_line");
    let writer = ProgrammableSink {
...
fn line_buffer_write0_normal() {
    debug!("test line_buffer_write0_normal");
    let writer = ProgrammableSink {
...
fn line_write_all_error() {
    debug!("test line_write_all_error");
    let writer = ProgrammableSink {
...
fn partial_multiline_buffering() {
    debug!("test partial_multiline_buffering");
    let writer = ProgrammableSink {
...
fn partial_multiline_buffering_without_full_line() {
    debug!("test partial_multiline_buffering_without_full_line");
    let writer = ProgrammableSink {
        // Write only up to 5 bytes at a time
        accept_prefix: Some(5),
        ..Default::default()
...
fn single_formatted_write() {
    debug!("test single_formatted_write");
...
fn bufreader_full_initialize() {
    debug!("test bufreader_full_initialize");
